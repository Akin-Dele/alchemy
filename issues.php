...
<div class="card shadow mb-4">
  ...
  <div class="card-body">
   ...
   <h6 class="text-success"><?php
    ...
    $query= 'SELECT * FROM anonymous WHERE attended=0 ORDER BY id DESC';
         ...
         <tr>
          ...
          <td>
              <form action="issue.php" method="POST">
                ...
                <button type="submit" name="issue" class="btn btn-success btn-sm"><i class="fas fa-user-edit fa-sm"></i></button>
              </form>
            </td>
         </tr>
         <?php
